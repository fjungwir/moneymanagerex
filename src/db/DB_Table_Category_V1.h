...
struct DB_Table_CATEGORY_V1 : public DB_Table
{
    ...
    {
        db->Begin();
        db->ExecuteUpdate(wxString::Format("INSERT INTO CATEGORY_V1 VALUES ('1', '%s')", wxTRANSLATE("Instrumente")));
        db->ExecuteUpdate(wxString::Format("INSERT INTO CATEGORY_V1 VALUES ('2', '%s')", wxTRANSLATE("Noten")));
        db->ExecuteUpdate(wxString::Format("INSERT INTO CATEGORY_V1 VALUES ('3', '%s')", wxTRANSLATE("Bekleidung")));
        db->ExecuteUpdate(wxString::Format("INSERT INTO CATEGORY_V1 VALUES ('4', '%s')", wxTRANSLATE("Musikheim-Probenlokal")));
        db->ExecuteUpdate(wxString::Format("INSERT INTO CATEGORY_V1 VALUES ('5', '%s')", wxTRANSLATE("Aus- und Fortbildung")));
        db->ExecuteUpdate(wxString::Format("INSERT INTO CATEGORY_V1 VALUES ('6', '%s')", wxTRANSLATE("Spesen")));
        db->ExecuteUpdate(wxString::Format("INSERT INTO CATEGORY_V1 VALUES ('7', '%s')", wxTRANSLATE("Versicherung")));
        db->ExecuteUpdate(wxString::Format("INSERT INTO CATEGORY_V1 VALUES ('8', '%s')", wxTRANSLATE("AKM")));
        db->ExecuteUpdate(wxString::Format("INSERT INTO CATEGORY_V1 VALUES ('9', '%s')", wxTRANSLATE("Diverse Ausgaben")));
        db->ExecuteUpdate(wxString::Format("INSERT INTO CATEGORY_V1 VALUES ('10', '%s')", wxTRANSLATE("Subventionen")));
        db->ExecuteUpdate(wxString::Format("INSERT INTO CATEGORY_V1 VALUES ('11', '%s')", wxTRANSLATE("Mitgliedsbeitraege")));
        db->ExecuteUpdate(wxString::Format("INSERT INTO CATEGORY_V1 VALUES ('12', '%s')", wxTRANSLATE("Spenden")));
        db->ExecuteUpdate(wxString::Format("INSERT INTO CATEGORY_V1 VALUES ('13', '%s')", wxTRANSLATE("Veranstaltungen")));
        db->ExecuteUpdate(wxString::Format("INSERT INTO CATEGORY_V1 VALUES ('14', '%s')", wxTRANSLATE("Diverse Einnahmen")));
